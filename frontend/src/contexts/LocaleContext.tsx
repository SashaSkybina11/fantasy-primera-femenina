...
const english: Record<TranslationKey, string> = {
  ...
  "prices.teamWin": "Team win bonus (€)",
  "prices.settingsHint": "Leave blank for no bonus. Changes apply to gameweeks whose prices have not yet been applied; previous gameweeks retain their settings.",
  "prices.saveSettings": "Save settings",
