...
const spanish = {
  ...
  "adminStats.searchPlaceholder": "Buscar por jugadora o club",
  ...
  "adminStats.participated": "Participó",
  ...
  "rules.marketBody": "El mercado abre los lunes a las 08:00 y cierra los viernes a las 19:00, hora de Madrid. Tras completar la plantilla inicial puedes vender 2 y fichar 2 jugadoras por jornada; los fichajes no se acumulan.",
  ...
  "rules.participation": "Participación",
  "rules.win": "Victoria",
  "rules.draw": "Empate",
...
const ukrainian: Record<TranslationKey, string> = {
  ...
  "adminStats.searchPlaceholder": "Пошук за гравчинею або клубом",
  ...
  "adminStats.participated": "Брала участь",
  ...
  "rules.marketBody": "Ринок відкривається щопонеділка о 08:00 і закривається щоп’ятниці о 19:00 за часом Мадрида. Після формування першого складу можна продати 2 та придбати 2 гравчинь за тур; трансфери не накопичуються.",
  ...
  "rules.participation": "Участь у матчі",
  "rules.win": "Перемога",
  "rules.draw": "Нічия",
