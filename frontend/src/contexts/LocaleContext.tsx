...
const spanish = {
  ...
  "auth.verifyDescription": "Introduce el código de 6 dígitos enviado a {{email}}. Es válido durante 10 minutos. Revisa también la carpeta de spam.",
  "auth.code": "Código de confirmación",
  "auth.verifyButton": "Confirmar correo",
  "auth.codeSent": "Hemos enviado un nuevo código.",
  "auth.resendCode": "Reenviar código",
  "auth.resendWait": "Volver a enviar en {{seconds}} s",
  "auth.changeEmail": "Cambiar correo o reiniciar registro",
  "auth.forgotPassword": "¿Has olvidado tu contraseña?",
  "auth.forgotTitle": "Recupera tu cuenta",
  "auth.forgotDescription": "Introduce tu correo para recibir un enlace y elegir una nueva contraseña.",
  "auth.sendReset": "Enviar enlace",
  "auth.resetSent": "Si existe una cuenta con este correo, recibirás un enlace válido durante 30 minutos. Revisa también la carpeta de spam.",
  "auth.resetTitle": "Nueva contraseña",
  "auth.resetDescription": "Elige una contraseña de al menos 8 caracteres. Después, inicia sesión de nuevo.",
  "auth.savePassword": "Guardar contraseña",
  "auth.resetSuccess": "Contraseña actualizada. Inicia sesión con tu nueva contraseña.",
  "auth.invalidReset": "El enlace no es válido. Solicita uno nuevo.",
  ...
  "matches.admin": "Partidos y puntos",
  "matches.intro": "Selecciona una jornada y abre el acta de un partido.",
  "matches.create": "Añadir partido",
  "matches.home": "Local",
  "matches.away": "Visitante",
  "matches.kickoff": "Fecha y hora",
  "matches.unscheduled": "Horario pendiente",
  "matches.empty": "Todavía no hay partidos en esta jornada.",
  "matches.report": "Acta del partido",
  "matches.scoreOnly": "Resultado confirmado. El acta de jugadoras se gestiona por separado.",
  "matches.pending": "Acta pendiente",
  "matches.published": "Publicado",
  "matches.draft": "Borrador",
  "matches.edit": "Editar acta",
  "matches.save": "Guardar borrador",
  "matches.publish": "Publicar y calcular puntos",
  "matches.saved": "Borrador guardado. Los puntos no han cambiado.",
  "matches.done": "Acta publicada y puntos actualizados.",
  "matches.starters": "Quinteto inicial",
  "matches.others": "Otras jugadoras",
  "matches.count": "Titulares: {{count}}/5 · Porteras: {{keepers}}/1",
  "matches.previous": "Usar el quinteto anterior",
  "matches.noPrevious": "No hay quinteto anterior disponible.",
  "matches.ownGoals": "Goles en propia puerta",
  "matches.ownHelp": "Los autogoles se suman al marcador rival, sin asignar un gol a otra jugadora.",
  "matches.points": "Puntos Fantasy",
  "matches.breakdown": "Desglose de puntos",
  "matches.back": "Volver a resultados",
  "matches.loading": "Cargando partidos…",
  "matches.error": "No se pudieron cargar los partidos.",
  "matches.retry": "Reintentar",
  "matches.locked": "Jornada finalizada. Reábrela desde la gestión de puntos para editar el acta.",
  "matches.legacy": "Correcciones y cierre de jornada",
  "matches.dirty": "Hay cambios sin guardar.",
  "matches.leave": "¿Descartar los cambios sin guardar?",
  "matches.scoreHelp": "Para publicar: 5 titulares y 1 portera por equipo; los goles y autogoles deben coincidir con el marcador.",
  "matches.editorHelp": "Marca el quinteto y añade los eventos. Los puntos se calculan al publicar.",
  "matches.adjustment": "Ajuste",
  "matches.result": "Resultado del equipo",
  "matches.hatTrick": "Bonus por hat-trick",
  "matches.cleanSheet": "Portería a cero",
  ...
  "squad.purchasePrice": "Precio de compra",
  "squad.initialPrice": "Precio inicial",
  "squad.priceUnknown": "No registrado",
  "squad.valueChange": "Cambio desde la compra",
  "leaderboard.movedUp": "Sube {count} posiciones",
  "leaderboard.movedDown": "Baja {count} posiciones",
  "leaderboard.unchanged": "Sin cambios",
  ...
  "player.allNationalities": "Todas las nacionalidades",
  "player.priceSort": "Ordenar por precio",
  "player.defaultSort": "Orden predeterminado",
  "player.priceDescending": "De mayor a menor precio",
  "player.priceAscending": "De menor a mayor precio",
  ...
  "squad.positionFull": "No hay plazas libres para esta posición.",
  "squad.details": "Ver detalles de {name}",
  "squad.addGoalkeeper": "Añadir portera de suplentes",
  "squad.addFieldPlayer": "Añadir jugadora de campo de suplentes",
  "squad.noBenchPlayers": "No hay suplentes disponibles para esta posición.",
...
const ukrainian: Record<TranslationKey, string> = {
  ...
  "auth.verifyDescription": "Введіть 6-значний код, надісланий на {{email}}. Він діє 10 хвилин. Перевірте також папку «Спам».",
  "auth.code": "Код підтвердження",
  "auth.verifyButton": "Підтвердити пошту",
  "auth.codeSent": "Новий код надіслано.",
  "auth.resendCode": "Надіслати код повторно",
  "auth.resendWait": "Повторне надсилання через {{seconds}} с",
  "auth.changeEmail": "Змінити пошту або почати реєстрацію знову",
  "auth.forgotPassword": "Забули пароль?",
  "auth.forgotTitle": "Відновлення доступу",
  "auth.forgotDescription": "Введіть пошту, щоб отримати посилання для встановлення нового пароля.",
  "auth.sendReset": "Надіслати посилання",
  "auth.resetSent": "Якщо обліковий запис із цією поштою існує, ви отримаєте посилання, що діє 30 хвилин. Перевірте також папку «Спам».",
  "auth.resetTitle": "Новий пароль",
  "auth.resetDescription": "Виберіть пароль щонайменше з 8 символів. Потім увійдіть знову.",
  "auth.savePassword": "Зберегти пароль",
  "auth.resetSuccess": "Пароль оновлено. Увійдіть із новим паролем.",
  "auth.invalidReset": "Посилання недійсне. Запросіть нове.",
  ...
  "matches.admin": "Матчі та очки",
  "matches.intro": "Оберіть тур і відкрийте протокол матчу.",
  "matches.create": "Додати матч",
  "matches.home": "Господарі",
  "matches.away": "Гості",
  "matches.kickoff": "Дата й час",
  "matches.unscheduled": "Час ще не визначено",
  "matches.empty": "У цьому турі ще немає матчів.",
  "matches.report": "Протокол матчу",
  "matches.scoreOnly": "Рахунок підтверджено. Протокол гравчинь заповнюється окремо.",
  "matches.pending": "Протокол готується",
  "matches.published": "Опубліковано",
  "matches.draft": "Чернетка",
  "matches.edit": "Редагувати протокол",
  "matches.save": "Зберегти чернетку",
  "matches.publish": "Опублікувати й нарахувати очки",
  "matches.saved": "Чернетку збережено. Очки не змінено.",
  "matches.done": "Протокол опубліковано, очки оновлено.",
  "matches.starters": "Стартова п’ятірка",
  "matches.others": "Інші гравчині",
  "matches.count": "Старт: {{count}}/5 · Воротарки: {{keepers}}/1",
  "matches.previous": "Взяти попередню стартову п’ятірку",
  "matches.noPrevious": "Попереднього стартового складу ще немає.",
  "matches.ownGoals": "Автоголи",
  "matches.ownHelp": "Автоголи додаються до рахунку суперника, без зарахування гола іншій гравчині.",
  "matches.points": "Fantasy-очки",
  "matches.breakdown": "Розрахунок очок",
  "matches.back": "Назад до результатів",
  "matches.loading": "Завантаження матчів…",
  "matches.error": "Не вдалося завантажити матчі.",
  "matches.retry": "Спробувати ще раз",
  "matches.locked": "Тур завершено. Відкрийте його знову в керуванні очками, щоб змінити протокол.",
  "matches.legacy": "Коригування та завершення туру",
  "matches.dirty": "Є незбережені зміни.",
  "matches.leave": "Відкинути незбережені зміни?",
  "matches.scoreHelp": "Для публікації: 5 стартових гравчинь і 1 воротарка в кожній команді; голи та автоголи мають відповідати рахунку.",
  "matches.editorHelp": "Позначте стартову п’ятірку та додайте події. Очки нараховуються під час публікації.",
  "matches.adjustment": "Коригування",
  "matches.result": "Результат команди",
  "matches.hatTrick": "Бонус за хет-трик",
  "matches.cleanSheet": "Сухий матч",
  ...
  "squad.purchasePrice": "Ціна придбання",
  "squad.initialPrice": "Початкова ціна",
  "squad.priceUnknown": "Не збережено",
  "squad.valueChange": "Зміна від придбання",
  "leaderboard.movedUp": "Піднялася на {count} місць",
  "leaderboard.movedDown": "Опустилася на {count} місць",
  "leaderboard.unchanged": "Без змін",
  ...
  "player.allNationalities": "Усі національності",
  "player.priceSort": "Сортування за ціною",
  "player.defaultSort": "За замовчуванням",
  "player.priceDescending": "Від більшої ціни до меншої",
  "player.priceAscending": "Від меншої ціни до більшої",
  ...
  "squad.positionFull": "Немає вільного місця для цієї позиції.",
  "squad.details": "Інформація про {name}",
  "squad.addGoalkeeper": "Додати воротарку із запасу",
  "squad.addFieldPlayer": "Додати польову гравчиню із запасу",
  "squad.noBenchPlayers": "У запасі немає гравчинь цієї позиції.",
...
const english: Record<TranslationKey, string> = {
  ...
  "auth.verifyDescription": "Enter the 6-digit code sent to {{email}}. It expires in 10 minutes. Please check your spam folder too.",
  "auth.code": "Verification code",
  "auth.verifyButton": "Verify email",
  "auth.codeSent": "A new code has been sent.",
  "auth.resendCode": "Resend code",
  "auth.resendWait": "Send again in {{seconds}} s",
  "auth.changeEmail": "Change email or restart registration",
  "auth.forgotPassword": "Forgot your password?",
  "auth.forgotTitle": "Recover your account",
  "auth.forgotDescription": "Enter your email to receive a link to choose a new password.",
  "auth.sendReset": "Send reset link",
  "auth.resetSent": "If an account exists with this email, you will receive a link valid for 30 minutes. Please check your spam folder too.",
  "auth.resetTitle": "New password",
  "auth.resetDescription": "Choose a password with at least 8 characters, then sign in again.",
  "auth.savePassword": "Save password",
  "auth.resetSuccess": "Password updated. Sign in with your new password.",
  "auth.invalidReset": "This link is invalid. Request a new one.",
  ...
  "matches.admin": "Matches and points",
  "matches.intro": "Choose a gameweek and open a match report.",
  "matches.create": "Add match",
  "matches.home": "Home",
  "matches.away": "Away",
  "matches.kickoff": "Date and time",
  "matches.unscheduled": "Time to be confirmed",
  "matches.empty": "No matches in this gameweek yet.",
  "matches.report": "Match report",
  "matches.scoreOnly": "Score confirmed. The player report is managed separately.",
  "matches.pending": "Report pending",
  "matches.published": "Published",
  "matches.draft": "Draft",
  "matches.edit": "Edit report",
  "matches.save": "Save draft",
  "matches.publish": "Publish and calculate points",
  "matches.saved": "Draft saved. Points are unchanged.",
  "matches.done": "Report published and points updated.",
  "matches.starters": "Starting five",
  "matches.others": "Other players",
  "matches.count": "Starters: {{count}}/5 · Goalkeepers: {{keepers}}/1",
  "matches.previous": "Use previous starting five",
  "matches.noPrevious": "No previous starting five available.",
  "matches.ownGoals": "Own goals",
  "matches.ownHelp": "Own goals count toward the opponent’s score without crediting another player.",
  "matches.points": "Fantasy points",
  "matches.breakdown": "Points breakdown",
  "matches.back": "Back to results",
  "matches.loading": "Loading matches…",
  "matches.error": "Could not load matches.",
  "matches.retry": "Retry",
  "matches.locked": "Gameweek completed. Reopen it in points management to edit the report.",
  "matches.legacy": "Adjustments and gameweek completion",
  "matches.dirty": "You have unsaved changes.",
  "matches.leave": "Discard unsaved changes?",
  "matches.scoreHelp": "To publish: 5 starters and 1 goalkeeper per team; goals and own goals must match the score.",
  "matches.editorHelp": "Select the starting five and add events. Points are applied when you publish.",
  "matches.adjustment": "Adjustment",
  "matches.result": "Team result",
  "matches.hatTrick": "Hat-trick bonus",
  "matches.cleanSheet": "Clean sheet",
  ...
  "squad.purchasePrice": "Purchase price",
  "squad.initialPrice": "Initial price",
  "squad.priceUnknown": "Not recorded",
  "squad.valueChange": "Change since purchase",
  "leaderboard.movedUp": "Up {count} places",
  "leaderboard.movedDown": "Down {count} places",
  "leaderboard.unchanged": "Unchanged",
  "common.pointsShort": "pts",
  "rules.badge": "Guide",
  ...
  "player.allNationalities": "All nationalities",
  "player.priceSort": "Sort by price",
  "player.defaultSort": "Default order",
  "player.priceDescending": "Price: high to low",
  "player.priceAscending": "Price: low to high",
  ...
  "squad.positionFull": "No free slot for this position.",
  "squad.details": "View details for {name}",
  "squad.addGoalkeeper": "Add goalkeeper from bench",
  "squad.addFieldPlayer": "Add field player from bench",
  "squad.noBenchPlayers": "No bench players available for this position.",
