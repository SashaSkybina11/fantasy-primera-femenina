  ...
  return (
    <div className="page home-page">
      ...
      <section className="home-actions" aria-label={t("home.actions")}>
        <Link className="home-action" to="/my-team">
          <span>
            <TbPlayFootball aria-hidden="true" />
          </span>
          <div>
            <h2>{t("nav.myTeam")}</h2>
            <p>{t("home.myTeam")}</p>
        ...
        <Link className="home-action" to="/purchase-players">
          <span>
            <GiBuyCard aria-hidden="true" />
          </span>
          <div>
            <h2>{t("nav.purchase")}</h2>
            <p>{t("home.purchase")}</p>
          </div>
        </Link>
        <Link className="home-action" to="/calendar">
          <span>
